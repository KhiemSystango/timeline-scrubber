...
function timelineRectAndCircle() {
  var chart = d3.timeline();
  var svg = d3
    .select("#timeline2_combine")
    .append("svg")
    .attr("width", width)
    .datum(rectAndCircleTestData)
    .call(chart);
}
...
function timelineRotatedTicks() {
  var chart = d3.timeline().rotateTicks(45);
  var svg = d3
    .select("#timeline7")
    .append("svg")
    .attr("width", width)
...
function timelineRectColors() {
  ...
  var chart = d3.timeline().colors(colorScale).colorProperty("fruit");
  var svg = d3
    .select("#timelineColors")
    .append("svg")
    .attr("width", width)
    .datum(testDataWithColor)
    .call(chart);
}
function timelineRectColorsPerTime() {
  ...
  var chart = d3.timeline().colors(colorScale).colorProperty("fruit");
  var svg = d3
    .select("#timelineColorsPerTime")
    .append("svg")
    .attr("width", width)
    .datum(testDataWithColorPerTime)
    .call(chart);
}
