...
function ZoomableBarChart3({ data, id = "myZoomableLineChart" }) {
  const svgRef = useRef();
  ...
  useEffect(() => {
    ...
    // const zDomain = new d3.InternSet(Y);
    ...
    //   update(xScale.invert(pointer(event)[0]));
    // }
...
export default ZoomableBarChart3;
